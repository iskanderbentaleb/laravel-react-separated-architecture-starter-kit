      ...
      >
        <Group mb="md">
          ...
          <Title order={3} size="h4">
            {t('seller.pages.settings.changePassword.title')}
          </Title>
        </Group>
        <PasswordCard
      ...
      >
        <Group justify="space-between" mb="md">
          <Group>
            ...
            <div>
              <Title order={3} size="h4">
                {t('seller.pages.settings.twoFactor.title')}
              </Title>
              <Text size="sm" c="dimmed">
                {t('seller.pages.settings.twoFactor.description')}
              </Text>
            </div>
          </Group>
          <Switch
        ...
        {twoFactorPending && (
          <Alert color="yellow" icon={<IconRefresh size={16} />} radius="md" mt="md">
            {t('seller.pages.settings.twoFactor.pendingMessage')}
          </Alert>
        )}

        {!userData.email_verified_at && (
          <Alert color="blue" icon={<IconShield size={16} />} radius="md" mt="md">
            {t('seller.pages.settings.twoFactor.verifyEmailBefore')}
          </Alert>
        )}
      </Paper>
      ...
      >
        <Group justify="space-between" mb="md">
          <Group>
            ...
            <Title order={3} size="h4">
              {t('seller.pages.settings.activeSessions.title')}
            </Title>
          </Group>
          <Button
            variant="default"
          ...
          >
            {t('seller.pages.settings.activeSessions.logoutAll')}
          </Button>
        </Group>
        ...
        <Stack gap="md">
          {sessions.length > 0 ? (
            ...
            <Text c="dimmed" size="sm">
              {t('seller.pages.settings.activeSessions.noActiveSessions')}
            </Text>
          )}
        </Stack>
      </Paper>
      ...
      >
        <Group mb="md">
          ...
          <Title order={3} size="h4" c="red">
            {t('seller.pages.settings.dangerZone.title')}
          </Title>
        </Group>
        <Card withBorder p="md" radius="md">
          <Group justify="space-between">
            <div>
              ...
              <Text size="sm" c="dimmed">
                {t('seller.pages.settings.dangerZone.deleteAccount.description')}
              </Text>
            </div>
