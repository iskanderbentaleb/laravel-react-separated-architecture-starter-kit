...
import { ADMIN_CATEGORIES_ROUTE, ADMIN_DASHBOARD_ROUTE } from '../../../Router';
  ...
  const mockdata = [
    {
      ...
      links: [
        { label: t('admin-AdminPages-Layout-NavbarNested-Child-Dashboard'), link: ADMIN_DASHBOARD_ROUTE },
    ...
    },
    {
      ...
      icon: IconCategory,
      links: [
        { label: t('admin-AdminPages-Layout-NavbarNested-Child-Products'), link: ADMIN_DASHBOARD_ROUTE },
        { label: t('admin-AdminPages-Layout-NavbarNested-Child-Categories'), link: ADMIN_CATEGORIES_ROUTE },
      ],
    },
  ];
